...
def load_agent_configs(base_path, task_type):
    ...
    content_path = os.path.join(base_path, "content_generation", f"{task_type}_content.json")
    instruction_path = os.path.join(base_path, "instruction_generation", f"{task_type}_instruction.json")
