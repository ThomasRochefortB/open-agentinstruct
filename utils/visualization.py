...
def main():
    ...
    parser.add_argument("--wrap_width", type=int, default=80, help="Width to wrap text for readability.")
    parser.add_argument("--filter", action="store_true", help="Only display complete samples with answers and choices.")
